...
if __name__ == '__main__':
    ...
    while not all_assigned:
        ...
        for good_mappings_  in batch(list(good_mappings), query_batch_n):
            db.execute(f'''
                INSERT INTO top_species_genome_read_mappings (species, genome, query, reference, rstart, rend, align_score, ani)
                SELECT species, genome, query, reference, rstart, rend, align_score, ani 
                FROM species_genome_read_mappings
